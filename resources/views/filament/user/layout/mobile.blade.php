...
<body class="h-full bg-gray-50 font-sans antialiased">
    ...
    <footer class="fixed-footer bg-white shadow-lg border-t border-gray-200">
        <div class="flex justify-around py-3 h-20">
            <a href="#" class="flex flex-col items-center justify-center text-blue-600 transition-colors">
                <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path>
                </svg>
                <span class="text-xs font-medium">Home</span>
            </a>
            <a href="#" class="flex flex-col items-center justify-center text-gray-400 hover:text-green-600 transition-colors">
                <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a href="#" class="flex flex-col items-center justify-center text-gray-400 hover:text-orange-600 transition-colors">
                <svg class="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
                    <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"></path>
                </svg>
                <span class="text-xs font-medium">Spese</span>
            </a>
            <a href="#" class="flex flex-col items-center justify-center text-gray-400 hover:text-purple-600 transition-colors">
    ...
    <!-- INPUT FILE NASCOSTO - APERTURA DIRETTA -->
    ...
    <script>
        ...
        function triggerAvatarUpload() {
            ...
            // Apri direttamente file picker con camera
            document.getElementById('avatarFileInput').click();
        }

        // Auto-submit quando file selezionato
        document.getElementById('avatarFileInput').addEventListener('change', function() {
            if (this.files && this.files[0]) {
                // Mostra loading
                const avatar = document.querySelector('.avatar-container button');
                avatar.innerHTML = `
